...
class ApiService {
  ...
  //  - Android emulator -> backend running on your dev machine: http://10.0.2.2:8000
  //  - iOS simulator -> backend on your dev machine:            http://localhost:8000
  ...
  Future<SearchResult> getHistoryItem(int id) async {
